...
R package **brick**, version **0.10.10**
...
Hasse R, Rosemann R (2025). "brick: Building sector model with heterogeneous renovation and construction of the stock." Version: 0.10.10, <https://github.com/pik-piam/brick>.
